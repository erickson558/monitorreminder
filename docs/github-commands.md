...
git init -b main
git add .
git commit -m "feat: bootstrap MonitorReminder V0.0.1"
...
- `git commit -m "feat: bootstrap MonitorReminder V0.0.1"`: creates the first professional commit.
...
```powershell
git add .
git commit -m "feat: improve monitor restore flow for V0.0.2"
git tag V0.0.2
